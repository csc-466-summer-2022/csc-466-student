...
import joblib
answers = {}
joblib.dump(answers,"../tests/answers_Lab1.joblib");
## END SOLUTION
...
#### BEGIN SOLUTION
a*b does element by element muliplication while dot does matrix multiplation where the inner dimmensions must match')
#### END SOLUTION
#### YOUR SOLUTION HERE
...
#### BEGIN SOLUTION
When multiplying matrices the outer dimmensions are the resulting size of the product.
#### END SOLUTION
#### YOUR SOLUTION HERE
...
## BEGIN SOLUTION
answers['exercise_4'] = row_means,col_means
## END SOLUTION
display(row_means)
display(col_means)
```
...
## BEGIN SOLUTION
answers['exercise_10'] = titanic_df_copy
## END SOLUTION
titanic_df_copy
```
...
## BEGIN SOLUTION
answers['exercise_11'] = model.coef_
## END SOLUTION
